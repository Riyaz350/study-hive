        ...
        <div className="">
            ...
            <div className="lg:grid grid-cols-4 max-w-7xl space-y-5 items-center mx-auto mt-10">
                <div className="col-span-3  text-center ">
                    <h1 className="text-4xl text-[#FFDDB6] p-3 rounded-lg bg-[#92140c] w-fit mx-auto">Available Assignments</h1>
                </div>
                <div className="col-span-1 flex lg:justify-end justify-center h-2/3 items-center ">
                    <select onChange={handleDifficulty} className="bg-[#92140c] p-2 text-[#FFDDB6] text-xl rounded-lg">
